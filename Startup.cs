...
using Asp.Saas.Data;
using Asp.Saas.Infrastructure;
using Asp.Saas.Infrastructure.ApplicationUserClaims;
using Asp.Saas.Infrastructure.AppSettingsModels;
using Asp.Saas.Models.Identity;
...
using Asp.Saas.Infrastructure.Startup;

namespace Asp.Saas.Free
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Cookie.Name = "Asp.Saas.DotNetCore.AppCookie";
            ...
            services.AddSession(options =>
            {
                ...
                options.Cookie.Name = "Asp.Saas.DotNetCore.SessionCookie";
                // You might want to only set the application cookies over a secure connection:
                // options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
                options.Cookie.SameSite = SameSiteMode.Strict;
                options.Cookie.HttpOnly = true;
